...
public class EditActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		groupSpinner.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				spinnerAdapter2= new ArrayAdapter<Integer>(EditActivity.this, android.R.layout.simple_spinner_item, ranklist.toArray(new Integer[ranklist.size()]));
				//设置样式
	...
	spinnerAdapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		...
		groupSpinner.setSelection(groupString);
		rankSpinner.setAdapter(spinnerAdapter2);
		rankSpinner.setSelection(rankString);
	...
	public void onClick(View v) {
		...
		case R.id.sure:			
			...
			Log.e("myhome", "116");
			passMessage.passMessage(2, bundle);
			finish();
			break;
		case R.id.cancle:
			finish();
